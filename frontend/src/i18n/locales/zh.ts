export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    multiGroupLabel: '可调度分组',
    multiGroupHint: '同一个 Key 可在同平台多个分组之间调度，并合并这些分组的模型。主分组会默认选中。',
    scheduleStrategy: '调度策略',
    scheduleCheapest: '优先最便宜',
    scheduleLowestLatency: '优先低延迟',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
  ...
  admin: {
    ...
    groups: {
      ...
      addAccounts: {
        action: '加账号',
        title: '添加账号到 {name}',
        description: '选择同平台账号，保存后会把当前分组追加到这些账号的关联分组中。',
        formTitle: '直接添加账号',
        formHint: '可搜索并选择同平台账号，保存分组时会自动追加绑定。',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          title: '每日签到',
          description: '用户每日签到可领取随机额度，增加用户活跃度。',
          enabled: '启用每日签到',
          enabledHint: '开启后用户仪表盘显示签到入口。',
          minAmount: '最小额度（美元）',
          maxAmount: '最大额度（美元）',
        },
        affiliate: {
