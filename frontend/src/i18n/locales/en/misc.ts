export default {
  ...
  payment: {
    ...
    balanceRequired: 'Required Balance',
    buyWithBalance: 'Buy with Balance',
    balanceFallbackHint: 'If your balance is insufficient, no balance will be deducted and the selected payment method will be used automatically.',
    balancePurchaseSuccess: 'Subscription purchased with account balance.',
    balanceFallbackToPayment: 'Insufficient balance. Switching to external payment without deducting your balance.',
    ...
    errors: {
      ...
      INSUFFICIENT_BALANCE: 'Insufficient balance for this subscription.',
  ...
  workbench: {
    ...
    description: 'Select your API Key to chat and generate images using this site\'s channels and quota.',
    manageKeys: 'Manage Keys',
    chat: 'Chat',
    image: 'Image',
    loadingKeys: 'Loading keys...',
    loadingModels: 'Loading models...',
    noKeysHint: 'No active keys yet. Create an API Key first.',
    keysReady: '{count} keys ready',
    chatWelcomeTitle: 'How can I help?',
    chatWelcome: 'Pick a key and model, then chat in a Grok-like clean interface.',
    assistant: 'Assistant',
    ...
    tipExplain: 'Explain what this code does',
    tipCode: 'Write a sorting function for me',
    tipTranslate: 'Translate this into English',
    imageWelcomeTitle: 'Generate a new image',
    imageWelcome: 'Enter a prompt and generate images with your selected key.',
    ...
    deleteChatMessage: 'Delete “{title}”? This cannot be undone.',
    modelPlaceholder: 'Search or type model name',
  ...
  modelSquare: {
    title: 'Model Square',
    description: 'Browse available channels, group rates, and pricing by model',
  ...
  checkin: {
    ...
    subtitle: 'Check in daily to receive random balance rewards',
    range: 'Today: ${min} ~ ${max}',
  ...
  activity: {
    title: 'Prize Wheel',
    subtitle: 'Draw from the current activity prize pool',
    draw: 'Draw',
    drawing: 'Drawing...',
    retry: 'Retry',
    ready: 'Your draw is available',
    won: 'Reward confirmed',
    prizes: 'Prize pool',
    history: 'Recent rewards',
    emptyHistory: 'No rewards yet',
    historyLoadFailed: 'Failed to load reward history',
    refreshFailed: 'Your reward is confirmed, but some account details could not be refreshed.',
    retryRefresh: 'Retry refresh',
    dailyRemaining: 'Today remaining',
    globalRemaining: 'Activity remaining',
    validityDays: '{days} days',
    expiresAt: 'Access expires {date}',
    balanceAfter: 'Balance after reward: ${amount}',
    balance: 'Balance',
    noEligible: 'No eligible prize is available',
    loadFailed: 'Failed to load activity',
    drawFailed: 'The draw could not be completed',
    prizeMismatch: 'The selected prize is not present on this wheel. Refresh and try again.',
    states: {
      disabled: 'This activity is not available',
      upcoming: 'Starts {date}',
      ended: 'This activity has ended',
      exhausted: 'All draws have been claimed',
      dailyExhausted: 'You have used all draws for today',
    },
    errors: {
      ACTIVITY_DISABLED: 'This activity is not available',
      ACTIVITY_UPCOMING: 'This activity has not started',
      ACTIVITY_ENDED: 'This activity has ended',
      ACTIVITY_EXHAUSTED: 'All draws have been claimed',
      ACTIVITY_DAILY_EXHAUSTED: 'You have used all draws for today',
      ACTIVITY_NO_ELIGIBLE_PRIZE: 'No eligible prize is available',
      ACTIVITY_CONFIG_CHANGED: 'The activity changed. Please draw again.',
    },
  },
  ...
  tokenRanking: {
    ...
    sortByRequests: 'By Requests',
    summary: {
      totalCost: 'Total Cost',
      totalTokens: 'Total Tokens',
      activeUsers: 'Active Users',
      avgCost: 'Avg Cost/User',
      myRank: 'My Rank',
    },
    columns: {
      user: 'User',
