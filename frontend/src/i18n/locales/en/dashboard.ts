export default {
  ...
  keys: {
    ...
    testKey: 'Test Key',
    testingKey: 'Testing',
    testKeySuccess: 'Model {model} is available with {latency} ms latency',
    testKeyUnavailable: 'Model {model} is unavailable ({latency} ms): {message}',
    testKeyFailed: 'Key test failed: {message}',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
