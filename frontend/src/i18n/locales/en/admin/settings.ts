    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          defaultAuditPoliciesHint: 'Controls local security policies, user risk profiles, and upstream error prompt recording. When off, only explicitly configured moderation applies.',
          localAuditAction: 'Local policy match action',
          localAuditActionOptions: {
            allow: 'Allow',
            review: 'Mark suspicious',
            block: 'Block',
          },
          localAuditActionHints: {
            allow: 'Allow immediately after a local rule match. Do not send to the audit model or record local-match risk.',
            review: 'Send matches to the audit model. Allow when no model is configured, the model is unavailable, or audit mode is asynchronous.',
            block: 'Return HTTP 403 immediately after a local rule match and record local-match risk.',
          },
        ...
        activity: {
          ...
          description: 'Configure the user prize wheel, campaign window, limits, and rewards.',
          configure: 'Configure Activity',
          modalTitle: 'Lottery Activity Configuration',
          enabled: 'Enable activity',
          enabledHint: 'Controls public visibility and whether users can draw.',
          activityId: 'Activity ID',
          activityIdHint: 'Lowercase letters, numbers, hyphens, and underscores. Changing it starts a separate draw history.',
          titleLabel: 'Campaign title',
          descriptionLabel: 'Campaign description',
          startAt: 'Starts at (local time)',
          endAt: 'Ends at (local time)',
          dailyLimit: 'Daily draws per user',
          globalLimit: 'Total activity draws',
          prizes: 'Prizes',
          prizeCount: '{count} of 12 prizes',
          defaultPrizeLabel: 'Prize {index}',
          balanceType: 'Balance',
          groupType: 'Group access',
          prizeType: 'Prize {index} type',
          prizeId: 'Prize ID',
          prizeLabel: 'Display label',
          weight: 'Weight',
          amount: 'Balance amount (USD)',
          group: 'Subscription group',
          selectGroup: 'Select an active group',
          validityDays: 'Validity days',
          activityIdChangeConfirm: 'Changing the activity ID separates future draws from the current activity history. Continue?',
          loadFailed: 'Failed to load activity configuration',
          saveFailed: 'Failed to save activity configuration',
          saved: 'Activity configuration saved',
          validation: {
            activityId: 'Activity ID must be a lowercase slug of 1-64 characters.',
            title: 'Campaign title must contain 1-120 characters.',
            description: 'Description cannot exceed 2000 characters.',
            dates: 'Start and end times are required, and start must be before end.',
            dailyLimit: 'Daily limit must be an integer between 1 and 100.',
            globalLimit: 'Global limit must be an integer between 1 and 10,000,000.',
            prizeCount: 'Configure between 2 and 12 prizes.',
            prizeId: 'Every prize needs a unique lowercase slug ID.',
            prizeLabel: 'Every prize label must contain 1-120 characters.',
            prizeLabelAt: 'The display label for prize {index} must contain 1-120 characters.',
            weight: 'Every prize weight must be a positive integer.',
            amount: 'Balance amounts must be 0.00000001-1,000,000 with at most 8 decimal places.',
            group: 'Group prizes require an active subscription group and 1-36,500 validity days.',
          },
        },
        affiliate: {
      ...
      mailProvider: {
        title: 'Email Sending Provider',
        description: 'Choose how emails are delivered to recipients',
        smtp: 'SMTP',
        smtpHint: 'Send through your own SMTP server',
        resend: 'Resend API',
        resendHint: 'Send through the Resend HTTPS API (resend.com)'
      },
      emailConfig: {
        export: 'Export Config',
        import: 'Import Config',
        exportTitle: 'Export email configuration as a JSON file',
        importTitle: 'Import email configuration from a JSON file',
      ...
      resend: {
        ...
        description: 'Send emails through the Resend HTTPS API',
        testConnection: 'Test Connection',
        testing: 'Testing...',
        apiKey: 'API Key',
        ...
        fromEmailHint: 'Must use a domain verified in your Resend account',
        fromName: 'From Name',
        fromNamePlaceholder: 'Sub2API'
      },
      testEmail: {
        title: 'Send Test Email',
        description: 'Send a test email to verify your email configuration',
      ...
      resendConnectionSuccess: 'Resend connection successful',
      resendConnectionFailed: 'Resend connection test failed',
