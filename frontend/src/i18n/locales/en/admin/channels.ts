export default {
    ...
    channels: {
      ...
      form: {
        ...
        searchAccountForModels: 'Search account',
        fetchModelsFromAccount: 'Get from account',
        fetchingAccountModels: 'Fetching',
        accountModelsAlreadyAdded: 'No model whitelist entries to add from this account',
        fetchAccountModelsError: 'Failed to fetch account models',
    ...
    riskControl: {
      ...
      protocol: 'Moderation protocol',
      protocolOpenAIModeration: 'OpenAI Moderation API',
      protocolQwen3Guard: 'Qwen3Guard Chat Completions',
      protocolAliyunGuardrails: 'Alibaba Cloud AI Guardrails',
      openaiModerationProtocolHint: 'Uses the /v1/moderations endpoint and category scores.',
      qwenProtocolHint: 'Uses /v1/chat/completions and parses Safety and Categories.',
      aliyunProtocolHint: 'Uses Alibaba Cloud Content Moderation AI Guardrails to review text input.',
      controversialAction: 'Controversial handling',
      controversialActionAllow: 'Allow and record',
      controversialActionBlock: 'Block the request',
      controversialActionHint: 'Controversial results are allowed and recorded by default; blocking rejects them before the main request.',
      qwenModelHint: 'Gitee AI defaults to Qwen3Guard-Gen-8B; change it to match the node model name if needed.',
      qwenImageUnsupportedHint: 'The first Qwen3Guard Chat release audits text only; image input reports the node limitation and follows fail-open behavior.',
      aliyunRegion: 'Region',
      aliyunRegionShanghai: 'China East 2 (Shanghai)',
      aliyunRegionBeijing: 'China North 2 (Beijing)',
      aliyunRegionHangzhou: 'China East 1 (Hangzhou)',
      aliyunRegionShenzhen: 'China South 1 (Shenzhen)',
      aliyunRegionChengdu: 'China Southwest 1 (Chengdu)',
      aliyunRegionSingapore: 'Singapore',
      aliyunRegionFrankfurt: 'Germany (Frankfurt)',
      aliyunService: 'Detection service',
      aliyunServiceHint: 'Defaults to the enhanced text security service query_security_check_pro.',
      aliyunEndpoint: 'Endpoint',
      aliyunCredentials: 'Alibaba Cloud credentials',
      aliyunCredentialsHint: 'Leave fields empty to keep and reuse stored credentials. Enter a new value to replace that field. The Secret is submitted once.',
      aliyunAccessKeyId: 'AccessKey ID',
      aliyunAccessKeyIdPlaceholder: 'Enter AccessKey ID; leave empty to keep it',
      aliyunAccessKeyIdHint: 'A stored ID is shown only in masked form; the full value is never returned.',
      aliyunAccessKeySecret: 'AccessKey Secret',
      aliyunAccessKeySecretPlaceholder: 'Enter a new Secret; leave empty to keep it',
      aliyunAccessKeySecretHint: 'The Secret is never displayed and is cleared immediately after a save or test request.',
      aliyunCredentialsConfigured: 'Credentials configured',
      aliyunCredentialsConfiguredMasked: 'Credentials configured: {id}',
      aliyunCredentialsPendingClear: 'Pending clear',
      clearAliyunCredentials: 'Clear stored credentials',
      keepAliyunCredentials: 'Keep stored credentials',
      aliyunCredentialsWillClear: 'Saving will clear both the AccessKey ID and Secret.',
      aliyunTextOnlyTitle: 'Text input only in the initial release',
      aliyunTextOnlyHint: 'Images skip external Alibaba Cloud moderation and are recorded as an audit error.',
      testAliyunConnection: 'Test connection',
      testingAliyunConnection: 'Testing',
      aliyunTestHint: 'Leave both ID and Secret empty to reuse stored credentials.',
      aliyunConnectionTestDone: 'Alibaba Cloud AI Guardrails connection test completed',
      aliyunConnectionTestFailed: 'Alibaba Cloud AI Guardrails connection test failed',
      baseUrl: 'Moderation node Base URL',
      model: 'Model',
      ...
      auditTestSeverity: 'Model result: {severity}',
      auditTestCategories: 'Model categories',
      auditSeveritySafe: 'Safe',
      auditSeverityUnsafe: 'Unsafe',
      auditSeverityControversial: 'Controversial',
      auditEndpointUnsupported: 'This moderation node does not support the selected interface. Check the protocol or use a node that supports Chat Completions.',
      ...
      syncAbuseTitle: 'Sync Relay Detection',
      syncAbuseRule: 'Flags sustained relay use when every complete minute in a fixed 10-minute window contains at least one synchronous request.',
      syncAbuseRpmLimit: 'RPM After Detection',
      syncAbuseConcurrency: 'Concurrency After Detection',
      syncAbuseDisableUser: 'Disable User on Detection',
      syncAbuseDisableUserHint: 'When off, only apply the RPM and concurrency above. When on, also disable the user account.',
      syncAbuseAllowlistPlaceholder: 'Search users exempt from sync relay detection',
      syncAbuseAllowlistHint: 'Selected users are excluded from sync relay detection.',
      cyberUsageTitle: 'Security-Policy Usage Detection',
      cyberUsageRule: 'Counts security-policy usage within the configured window. Reaching the threshold disables the user.',
      cyberUsageBanThreshold: 'Disable Threshold',
      cyberUsageWindowHours: 'Detection Window (hours)',
      cyberUsageAllowlistPlaceholder: 'Search users exempt from security-policy usage detection',
      cyberUsageAllowlistHint: 'Selected users are excluded from security-policy usage detection.',
      userAllowlist: 'User Allowlist',
      userAllowlistSearchPlaceholder: 'Search users by email',
      userAllowlistSearchEmpty: 'No users found',
      userAllowlistDeleted: '(deleted)',
      userAllowlistFallback: 'User #{id}',
      userAllowlistRemove: 'Remove user',
      ...
      riskThresholdsHint: 'Adjust hit thresholds by moderation category for OpenAI Moderations and Qwen3Guard. Scores greater than or equal to the threshold count as hits.',
