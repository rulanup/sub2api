export default {
    ...
    riskControl: {
      ...
      riskThresholdsHint: 'Adjust hit thresholds by moderation category for the selected engine and protocol. Scores greater than or equal to the threshold count as hits.',
