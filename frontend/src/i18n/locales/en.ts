export default {
  ...
  keys: {
    ...
    multiGroupLabel: 'Schedulable groups',
    multiGroupHint: 'One key can schedule across multiple same-platform groups and merge models from those groups. The primary group is always selected.',
    scheduleStrategy: 'Scheduling strategy',
    scheduleCheapest: 'Cheapest first',
    scheduleLowestLatency: 'Lowest latency first',
    statusLabel: 'Status',
  ...
  workbench: {
    title: 'Workbench',
    description: 'Select your API Key to chat, generate images, and edit images using the site\'s channels and quota.',
    manageKeys: 'Manage Keys',
    chat: 'Chat',
    image: 'Image',
    chatWelcome: 'Hello, I will use your selected API Key to make requests.',
    ...
    imageWelcome: 'Describe the image you want to generate.',
  ...
  admin: {
    ...
    groups: {
      ...
      addAccounts: {
        action: 'Add Accounts',
        title: 'Add Accounts to {name}',
        description: 'Select accounts on the same platform. Saving appends this group to their linked groups.',
        formTitle: 'Add Accounts Directly',
        formHint: 'Search and select same-platform accounts. They will be linked when the group is saved.',
        searchPlaceholder: 'Search account name...',
        selectPlaceholder: 'Select account...',
        empty: 'No accounts available to add',
        selected: '{count} accounts selected',
        clearSelection: 'Clear selection',
        submit: 'Add Accounts',
        success: 'Added {count} accounts',
        failedToLoad: 'Failed to load accounts',
        failedToSave: 'Failed to add accounts'
      },
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          title: 'Daily Check-in',
          description: 'Users can check in daily to receive random balance rewards, boosting engagement.',
          enabled: 'Enable Daily Check-in',
          enabledHint: 'When enabled, a check-in card appears on the user dashboard.',
