export default {
  ...
  keys: {
    ...
    testKey: '测 Key',
    testingKey: '测试中',
    testKeySuccess: '模型 {model} 可用，延迟 {latency} ms',
    testKeyUnavailable: '模型 {model} 不可用（{latency} ms）：{message}',
    testKeyFailed: 'Key 测试失败：{message}',
    enable: '启用',
    disable: '禁用',
    nameLabel: '名称',
    ...
    ccsImportUnsupported: '当前分组平台无法导入到兼容的 CC-Switch 客户端。',
    ccsClientSelect: {
      title: '选择客户端',
      description: '请选择本次导入的客户端。',
      clients: {
        claude: {
          label: 'Claude Code',
          description: '导入 Claude Code 供应商'
        },
        codex: {
          label: 'Codex',
          description: '导入 Codex 供应商'
        },
        opencode: {
          label: 'OpenCode',
          description: '导入 OpenCode 供应商'
        },
        gemini: {
          label: 'Gemini CLI',
          description: '导入 Gemini CLI 供应商'
        },
        grokbuild: {
          label: 'Grok Build',
          description: '导入 Grok Build 供应商'
        }
      }
    },
    // 配额和有效期
