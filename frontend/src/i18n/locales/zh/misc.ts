export default {
  ...
  payment: {
    ...
    currentBalance: '当前余额',
    balanceRequired: '所需余额',
    buyWithBalance: '使用余额购买',
    balanceFallbackHint: '余额不足时不会扣款，系统会自动改用所选支付方式。',
    balancePurchaseSuccess: '已使用账户余额购买订阅。',
    balanceFallbackToPayment: '余额不足，未扣除余额，已自动切换为外部支付。',
    groupFallback: '分组 #{id}',
    ...
    errors: {
      ...
      INSUFFICIENT_BALANCE: '账户余额不足以购买此订阅',
      INVALID_AMOUNT: '金额无效',
      INVALID_INPUT: '参数有误',
  ...
  workbench: {
    title: '在线工作台',
    badge: '本地体验',
    description: '选择自己的 API Key，使用当前站点的渠道与额度进行聊天和图片生成。',
    manageKeys: '管理密钥',
    chat: '聊天',
    image: '图片',
    loadingKeys: '正在加载密钥...',
    loadingModels: '正在加载模型...',
    noKeysHint: '暂无可用密钥，请先创建 API Key',
    keysReady: '已加载 {count} 个密钥',
    chatWelcomeTitle: '有什么可以帮你？',
    chatWelcome: '选择密钥和模型后开始对话，体验接近主流 AI 官网的聊天界面。',
    assistant: '助手',
    ...
    clearChat: '清空对话',
    tipExplain: '解释这段代码的作用',
    tipCode: '帮我写一个排序函数',
    tipTranslate: '把这段话翻译成英文',
    imageWelcomeTitle: '生成一张新图片',
    imageWelcome: '输入提示词，使用选中的密钥调用图片模型。',
    ...
    deleteChatMessage: '确定删除「{title}」吗？此操作不可恢复。',
  ...
  activity: {
    ...
    history: '最近奖励',
    emptyHistory: '暂无奖励记录',
    historyLoadFailed: '奖励记录加载失败',
    refreshFailed: '奖励已确认，但部分账户信息刷新失败。',
    retryRefresh: '重试刷新',
    dailyRemaining: '今日剩余',
    globalRemaining: '活动剩余',
    validityDays: '{days} 天',
    expiresAt: '访问权限到期时间：{date}',
    balanceAfter: '奖励后余额：${amount}',
    balance: '余额',
    noEligible: '当前没有可领取的奖品',
    loadFailed: '活动加载失败',
    drawFailed: '抽奖未能完成',
    prizeMismatch: '服务端返回的奖品不在当前转盘中，请刷新后重试。',
    states: {
      disabled: '活动暂未开放',
      upcoming: '活动将于 {date} 开始',
      ended: '活动已结束',
      exhausted: '活动抽奖次数已全部用完',
      dailyExhausted: '今日抽奖次数已用完',
    },
    errors: {
      ACTIVITY_DISABLED: '活动暂未开放',
      ACTIVITY_UPCOMING: '活动尚未开始',
      ACTIVITY_ENDED: '活动已结束',
      ACTIVITY_EXHAUSTED: '活动抽奖次数已全部用完',
      ACTIVITY_DAILY_EXHAUSTED: '今日抽奖次数已用完',
      ACTIVITY_NO_ELIGIBLE_PRIZE: '当前没有可领取的奖品',
      ACTIVITY_CONFIG_CHANGED: '活动配置已更新，请重新抽奖。',
    },
  },
