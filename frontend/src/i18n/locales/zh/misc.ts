export default {
  ...
  workbench: {
    title: '在线工作台',
    description: '选择自己的 API Key，使用当前站点的渠道与额度进行聊天、生图和图改图。',
    manageKeys: '管理密钥',
    chat: '聊天',
    image: '图片',
    chatWelcome: '你好，我会使用你选中的 API Key 发起请求。',
  ...
  checkin: {
    ...
    checkingIn: '签到中...',
    success: '签到成功！',
    addedToBalance: '已添加到余额',
    doneToday: '今日已签到',
    comeBackTomorrow: '明天再来哦～',
    notCheckedIn: '还没签到',
    disabled: '签到功能暂未开启',
    rules: '签到规则',
    rule1: '每天只能签到一次',
