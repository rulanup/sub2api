    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          defaultAuditPoliciesHint: '控制本地安全策略、用户风险画像和上游错误提示词记录。关闭后仅保留显式配置的审查能力。',
          localAuditAction: '本地策略命中方式',
          ...
          localAuditActionHints: {
            allow: '命中本地规则后立即放行，不送审查模型，也不记录本地命中风险。',
            review: '命中后送审查模型裁决；未配置模型、模型不可用或异步模式时放行。',
            block: '命中本地规则后立即返回 403，并记录本地命中风险。',
          },
        ...
        activity: {
          title: '抽奖活动',
          description: '配置用户幸运转盘、活动时间、抽奖次数和奖励。',
          configure: '配置活动',
          modalTitle: '抽奖活动配置',
          enabled: '启用活动',
          enabledHint: '控制用户入口是否显示以及用户能否抽奖。',
          activityId: '活动 ID',
          activityIdHint: '仅限小写字母、数字、连字符和下划线。修改后将使用独立的抽奖记录。',
          titleLabel: '活动标题',
          ...
          globalLimit: '活动总抽奖次数',
          prizes: '奖品',
          prizeCount: '已配置 {count} / 12 个奖品',
          defaultPrizeLabel: '奖品 {index}',
          balanceType: '余额',
          groupType: '分组权限',
          prizeType: '奖品 {index} 类型',
          prizeId: '奖品 ID',
          prizeLabel: '展示名称',
          weight: '权重',
          amount: '余额金额（美元）',
          ...
          selectGroup: '选择启用的分组',
          validityDays: '有效天数',
          activityIdChangeConfirm: '修改活动 ID 后，后续抽奖将与当前活动记录分开。是否继续？',
          loadFailed: '加载活动配置失败',
          saveFailed: '保存活动配置失败',
          saved: '活动配置已保存',
          validation: {
            activityId: '活动 ID 必须是 1-64 位小写 slug。',
            title: '活动标题长度必须为 1-120 个字符。',
            description: '活动描述不能超过 2000 个字符。',
            dates: '请填写开始和结束时间，且开始时间必须早于结束时间。',
            dailyLimit: '每日次数必须是 1-100 的整数。',
            globalLimit: '活动总次数必须是 1-10,000,000 的整数。',
            prizeCount: '请配置 2-12 个奖品。',
            prizeId: '每个奖品都必须使用唯一的小写 slug ID。',
            prizeLabel: '每个奖品名称长度必须为 1-120 个字符。',
            prizeLabelAt: '第 {index} 个奖品的展示名称必须为 1-120 个字符。',
            weight: '每个奖品权重必须是正整数。',
            amount: '余额金额必须为 0.00000001-1,000,000，且最多 8 位小数。',
            group: '分组奖品必须选择有效订阅分组，有效期为 1-36,500 天。',
          },
        },
        affiliate: {
          title: '邀请返利',
      ...
      mailProvider: {
        title: '邮件发送通道',
        description: '选择邮件的实际投递方式',
        smtp: 'SMTP',
        smtpHint: '通过自建 SMTP 服务器发送',
        resend: 'Resend API',
        resendHint: '通过 Resend HTTPS API 发送（resend.com）'
      },
      emailConfig: {
        export: '导出配置',
        import: '导入配置',
        exportTitle: '将邮件配置导出为 JSON 文件',
        importTitle: '从 JSON 文件导入邮件配置',
      ...
      resend: {
        title: 'Resend 设置',
        description: '通过 Resend HTTPS API 发送邮件',
        testConnection: '测试连接',
        testing: '测试中...',
        apiKey: 'API Key',
        ...
        fromEmailHint: '必须使用 Resend 账号中已验证的域名',
        fromName: '发件人名称',
        fromNamePlaceholder: 'Sub2API'
      },
      testEmail: {
        title: '发送测试邮件',
        description: '发送测试邮件以验证邮件配置',
      ...
      resendConnectionSuccess: 'Resend 连接成功',
      resendConnectionFailed: 'Resend 连接测试失败',
