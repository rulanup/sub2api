...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/email-config/export", h.Admin.Setting.ExportEmailConfig)
		adminSettings.POST("/email-config/import", h.Admin.Setting.ImportEmailConfig)
...
func registerErrorPassthroughRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	rules := admin.Group("/error-passthrough-rules")
	{
		...
		rules.GET("/whitelist", h.Admin.ErrorPassthrough.GetWhitelist)
		rules.PUT("/whitelist", h.Admin.ErrorPassthrough.UpdateWhitelist)
