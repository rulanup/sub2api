...
// LockUserForSubscription 是合并自 fork 的用户级订阅锁；事务由 BulkSubscriptionAction 提供。
func (r *transactionalBulkSubscriptionRepo) LockUserForSubscription(context.Context, int64) error {
	return nil
}
