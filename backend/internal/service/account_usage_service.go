...
type UsageLogRepository interface {
	...
	GetLeaderboard(ctx context.Context, startTime, endTime time.Time, limit int, callerUserID int64) (*usagestats.LeaderboardResponse, error)
	GetLeaderboardMyRank(ctx context.Context, startTime, endTime time.Time, callerUserID int64) (*usagestats.LeaderboardMyRank, error)
