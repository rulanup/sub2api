...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	promptErrorService := securityaudit.NewPromptErrorService(postgreSQLRepository)
	...
	coordinator := securityaudit.ProvideCoordinator(legacyEngine, promptService, userRiskScoreService)
