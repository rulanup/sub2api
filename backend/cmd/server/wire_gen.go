...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	promptErrorService := securityaudit.NewGatedPromptErrorService(postgreSQLRepository, contentModerationService)
	promptErrorHandler := securityaudit.NewPromptErrorAdminHandler(promptErrorService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, userRiskScoreService, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, promptErrorHandler, paymentHandler, affiliateHandler, complianceHandler, adminLotteryActivityHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	coordinator := securityaudit.ProvideCoordinator(legacyEngine, promptService, userRiskScoreService, contentModerationService)
